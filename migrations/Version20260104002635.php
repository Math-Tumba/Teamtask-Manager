 ...
 */
final class Version20260104002635 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_friend_request ALTER id ADD GENERATED BY DEFAULT AS IDENTITY');
        $this->addSql('ALTER TABLE user_friendship ALTER id ADD GENERATED BY DEFAULT AS IDENTITY');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_friend_request ALTER id DROP IDENTITY');
        $this->addSql('ALTER TABLE "user_friendship" ALTER id DROP IDENTITY');
    }
}
